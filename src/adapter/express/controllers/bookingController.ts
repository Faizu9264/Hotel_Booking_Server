...
export const createBookingController = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const createdBooking = await bookingUseCase.createBooking(rearrangedBookingDetails as Booking);
...
export const getAllBookingsController = async (_req: Request, res: Response): Promise<void> => {
  try {
...
export const handleWebhookEvent = async (req: CustomRequest, res: Response): Promise<void> => {
  try {
    ...
    switch (event.type) {
      case 'payment_intent.succeeded':
          ...
          await createBookingController({ body: { bookingDetails, userId } } as Request, res);
        break;
      default:
...
export const getBookingsByUserController = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const cancelBookingController = async (req:ExtendedRequest, res: Response): Promise<void> => {
  try {
...
export const approveBookingController = async (req: ExtendedRequest, res: Response): Promise<void> => {
  try {
    const { user, params } = req;
    const { bookingId } = params;
