...
router.post("/add-coupon", couponController_1.addCouponController);
router.patch("/edit-coupon/:couponId", couponController_1.editCouponController);
router.get("/get-all-coupons", couponController_1.getAllCouponsController);
router.post("/refund-booking", adminController_1.RefundController);
